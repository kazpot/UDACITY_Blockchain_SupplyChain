...
contract SupplyChain {
  ...
  modifier stored(uint _upc) {
    require(items[_upc].itemState == State.Stored);
    _;
  }
  ...
  // Define a function 'storetItem' that allows a farmer to mark an item 'Stored'
  function storeItem(uint _upc) public harvested(_upc) verifyCaller(items[_upc].originFarmerID)
  ...
  function packItem(uint _upc) public stored(_upc) verifyCaller(items[_upc].originFarmerID)
  // Call modifier to check if upc has passed previous supply chain stage
